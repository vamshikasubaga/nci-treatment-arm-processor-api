class BasicTreatmentArmJob
  ...
  def find_patient_count_for_status(treatment_arm=nil, status_list=[])
    TreatmentArmAssignmentEvent.scan(:scan_filter => {"treatment_arm_id" => {:comparison_operator => "CONTAINS", :attribute_value_list => [treatment_arm.id]},
                                              ...
                                              "patient_status" => {:comparison_operator => "IN", :attribute_value_list => status_list}},
